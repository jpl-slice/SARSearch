...
def main():
    ...
    """
    parser = argparse.ArgumentParser(description="SARSearch: A command-line tool for managing SAR data processing.")
    parser.add_argument('-c', '--config', help='Path to configuration file', required=False)
    parser.add_argument('-g', '--granule-file', help='File path for granules list', required=False)
